...
/*
 from https://github.com/HeshamMegid/HMSegmentedControl.git
 */

#import <UIKit/UIKit.h>

@class IDBSegmentedControl;

typedef void (^IndexChangeBlock)(NSInteger index);
typedef NSAttributedString *(^HMTitleFormatterBlock)(IDBSegmentedControl *segmentedControl, NSString *title, NSUInteger index, BOOL selected);
...
@interface IDBSegmentedControl : UIControl
